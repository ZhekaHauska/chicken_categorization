...
from cat_mod.models.representations.spatial_pooler.sdr import SparseSdr
...
from cat_mod.models.representations.spatial_pooler.sp_utils import (
    gather_rows,
    sample_for_each_neuron
)
from cat_mod.models.representations.spatial_pooler.se_utils import boosting
